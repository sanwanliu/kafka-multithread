...
public abstract class AbstractConsumerRebalanceListener implements ConsumerRebalanceListener {
    ...
    public void onPartitionsRevoked(Collection<TopicPartition> topicPartitions) {
        ...
        log.info("message processor-" + processor.getProcessorId() + " origin assignments --->> " + TPStrUtil.topicPartitionsStr(topicPartitions));
        try {
    ...
    public void onPartitionsAssigned(Collection<TopicPartition> topicPartitions) {
        ...
        log.info("message processor-" + processor.getProcessorId() + " new assignments --->> " + TPStrUtil.topicPartitionsStr(topicPartitions));
        try {
